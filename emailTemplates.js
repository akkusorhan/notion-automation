...
const emailFooter = `
    <h3 style="margin: 5px 0;">Connor Choi</h3>
    <p style="margin: 5px 0;">Digital Marketing Consultant & Web Designer</p>
    <p style="margin: 5px 0;">+1 (949) 214-6791</p>
    <p style="margin: 5px 0;"><a href="mailto:connor@blackwader.com">connor@blackwader.com</a></p>
...
const emailTemplates = {
    ...
    leadGeneratedBody: 
        `<p>I’m Connor Choi, a Wix Partner. Thanks for contacting me through the Wix Marketplace. I received your request and would like to discuss this project further.</p>
        ...
        <p>Please schedule a time, call our phone number at <strong>+1 (949) 214-6791 or simply reply to this email</strong> with how we can move forward along with any specifics, and we can go from there! Looking forward to hearing from you. In the meantime feel free to take a look at some of our previous projects, <a href="https://www.blackwader.com/web-design">linked here</a>. </p>
    ...
    seoLeadGeneratedBody: 
        `<p>I'm Connor Choi, an SEO specialist and Wix Partner. Thank you for reaching out through the Wix Marketplace. I received your request and would love to discuss your SEO project in more detail.</p>
        ...
        <p>We specialize in improving SEO through a comprehensive approach that includes keyword optimization, content creation, backlink building, and technical SEO enhancements. For instance, we recently increased organic (unpaid) website traffic by 2500% for Pathway Therapy Center, leading to more phone calls, leads, scheduled sessions, and significant brand exposure. You can read the full case study <a href="https://www.blackwader.com/seo-case-study">here</a>.</p>
        <p>Please schedule a time, call us at <strong>+1 (949) 214-6791, or reply to this email</strong> with any details about your project and we can proceed from there. Looking forward to hearing from you. In the meantime, feel free to learn more about our SEO services <a href="https://www.blackwader.com/seo">here</a>.</p>
        <p><strong>Btw, this isn't some automated campaign; I promise :)</strong></p>
        <p>Kind Regards,</p>
        --
        ${emailFooter}
