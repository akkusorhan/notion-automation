...
const emailFooter = `
    ...
    <p style="margin: 5px 0;">+1 (949) 426-8611</p>
...
const emailTemplates = {
    ...
    leadGeneratedBody: 
        ...
        <p>Please schedule a time, call our phone number at <strong>+1 (949) 426-8611 or simply reply to this email</strong> with how we can move forward along with any specifics, and we can go from there! Looking forward to hearing from you. In the meantime feel free to take a look at some of our previous projects, <a href="https://www.blackwader.com/web-design">linked here</a>. </p>
    ...
    seoLeadGeneratedBody: 
        ...
        <p>Please schedule a time, call us at <strong>+1 (949) 426-8611, or reply to this email</strong> with any details about your project and we can proceed from there. Looking forward to hearing from you. In the meantime, feel free to learn more about our SEO services <a href="https://www.blackwader.com/seo">here</a>.</p>
        <p><strong>Btw, this isn't some automated campaign; I promise :)</strong></p>
        <p>Kind Regards,</p>
        --
        ${emailFooter}
